...
4. Per ASR, scegliere prima il modello (`tiny`, `base` o `small`) e usare “Scarica e prepara ASR locale”: scarica il runtime da jsDelivr e il modello selezionato da Hugging Face; nessun audio/testo viene inviato per l’inferenza. “Trascrivi” non avvia download. Scollegare poi la rete e usare “Verifica cache offline”.
