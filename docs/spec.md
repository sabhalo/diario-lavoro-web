...
Stato: **specifica storica della prima versione**. Questa specifica sintetizza le scelte delegate registrate nella [mappa Wayfinder](../.scratch/diario-di-lavoro/map.md) e nei [ticket 01–07](../.scratch/diario-di-lavoro/issues/). Il [ticket «Solo media e cattura continua»](../.scratch/diario-di-lavoro/issues/08-solo-media-e-cattura-continua.md) documenta la successiva versione senza ASR. La nuova evoluzione della trascrizione è descritta nella [specifica locale a due percorsi](../.scratch/local-transcription/spec.md) e nella sua [matrice di verifica](verification/local-transcription-matrix.md); quelle fonti hanno precedenza sulle sezioni ASR storiche qui sotto. La prova breve dei tre flussi resta positiva **solo secondo il resoconto dell'utente**; le prove tecniche reali e il gate policy restano distinti.
