...
Stato: **specifica storica, aggiornata dal ticket 08 il 2026-09-23; build da validare sul Mac aziendale**. Questa specifica sintetizza le scelte delegate registrate nella [mappa Wayfinder](../.scratch/diario-di-lavoro/map.md) e nei [ticket 01–07](../.scratch/diario-di-lavoro/issues/). Il [ticket «Solo media e cattura continua»](../.scratch/diario-di-lavoro/issues/08-solo-media-e-cattura-continua.md) ha precedenza sulle sezioni ASR di questo documento: la build corrente registra soltanto video/audio, non importa o esegue ASR, non conserva trascrizioni e non esporta testo derivato dall'audio. AC7 e gli aspetti ASR di AC8/AC10 non sono quindi criteri della build corrente. La prova breve dei tre flussi resta positiva **solo secondo il resoconto dell'utente**; le prove tecniche reali e il gate policy restano distinti.
