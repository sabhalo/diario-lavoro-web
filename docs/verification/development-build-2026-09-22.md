...
| AC7 sul Mac | L’utente riferisce che la trascrizione italiana del microfono era quasi vuota, con sorgente microfono selezionata correttamente; la seconda prova è migliorata ma resta inutilizzabile. Il loop Windows ha riprodotto Small fp16/WebGPU con output vuoto e il profilo è stato ritirato; Small q8/WASM passa solo il campione sintetico | Non superato secondo l’utente; la causa Mac non è identificata |
