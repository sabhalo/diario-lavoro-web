...
Non sono stati eseguiti AC1–AC10, né test di due ore, MediaRecorder sul Mac, recupero dopo crash/revoca/sleep, quota, riproducibilità di blocchi reali, ASR locale, cache offline o riapertura di export. Per tali prove usare la matrice della specifica sul Mac/profilo Chrome di destinazione e registrare versioni, procedura, misure, lacune ed esito.
