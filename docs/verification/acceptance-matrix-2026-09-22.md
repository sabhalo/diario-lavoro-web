...
| AC9 | Non verificato | Nessuna cattura continua di almeno due ore sul Mac. | Eseguire una sessione ≥2 h con schermo/audio innocui e microfono facoltativo solo se consentito; annotare inizio/fine, continuità, spazio, memoria/reattività, lag ASR, blocchi, ricerca ed export. |
