...
- Quando l'utente chiede «protocollo Karen» o «Wayfinder automatico» per coordinare ticket, deleghe o modelli, leggere i documenti canonici `C:/Users/david/.codex/protocols/protocollo-karen.md` e `C:/Users/david/.codex/protocols/wayfinder-automatico.md` secondo le istruzioni AGENTS.md correnti. I protocolli sono opzionali; per questo lavoro l'utente li ha richiesti e ha approvato l'implementazione completa il 2026-09-22.
...
- Verifiche aperte: la prova breve Mac dei tre flussi è positiva **secondo il resoconto dell'utente**, non osservata dall'agente; versioni esatte, dettagli API/permessi e policy non sono stati comunicati. L'utente riferisce inoltre che la trascrizione dell'ultima build è «decisamente molto, molto meglio» e per ora adeguata: AC7 è superato **solo secondo testimonianza utente**; profilo/modello effettivo, Chrome, metriche, timestamp e benchmark non sono stati forniti. Restano da verificare sulla build finale limiti di archiviazione browser, recupero dopo interruzioni, prestazioni, prova di almeno due ore e gli AC non coperti dalla testimonianza. Policy aziendali per l'uso reale non accertate.
...
- [Verificare trascrizione e persistenza locali nel browser](issues/02-verificare-trascrizione-e-persistenza-locali.md): pipeline candidata Whisper locale, OPFS e IndexedDB; AC7 è ora positivo secondo testimonianza utente, ma profilo, timestamp, prestazioni, durata e recupero restano da misurare sul Mac aziendale.
