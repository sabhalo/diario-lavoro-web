const CACHE = "diario-lavoro-v16";
const ASSETS = ["./", "./index.html", "./styles.css", "./src/app.js", "./src/core.js", "./src/asr-core.js", "./src/media-core.js", "./test/fixtures/italian-synthetic.wav"];
