...
Il coordinatore ha riferito uno smoke reale Windows con `whisper-cli` v1.9.2 CPU e `large-v3-turbo-q5_0` con SHA-1 ufficiale verificato: clip CC0 italiana di 2,64 s, testo corrispondente al riferimento «Aspettiamo un po', perché a volte ci vuole un po' di tempo.» e segmento 0,0–2,4 s. Questo verifica quel singolo clip e quel dispositivo, non la qualità generale, le prestazioni su sessioni lunghe o il Mac. Una prova identica sul Mac di destinazione resta da svolgere.
